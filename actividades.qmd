...
Todos el historial de eventos y próximas actividades de **R en Buenos Aires** se encuentran registrados en [![Meetup icon](https://cdn.worldvectorlogo.com/logos/meetup-1.svg){width="20px" style="vertical-align: middle;"} Meetup.com](https://www.meetup.com/es-es/renbaires/). Y los materiales están disponibles en el repositorio del capítulo en [![GitHub icon](https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg){width="20px" style="vertical-align: middle;"} GitHub](https://github.com/renbaires)
:::
...
| 2026-03-18 | Encuentro de Comunidades Informáticas | UMET | [Nota de prensa](https://informaticos.ar/encuentro-de-comunidades-informaticas/) |
